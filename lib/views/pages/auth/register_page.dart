...
import '../../../extention/ex_build_context.dart';
...
class _ResisterPageState extends State<ResisterPage> {
  ...
  // TODO(kenta-wakasa): 使われていない変数はコード読む人の負担になる。
  String errorMessage = '';
              ...
              Button(
                onPressed: () async {
                  ...
                  try {
                    ...
                    if (context.mounted) {
                      pushReplacement(context, const TopPage());
                      context.pushReplacement(const TopPage());
